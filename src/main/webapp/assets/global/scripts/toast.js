...
var Toast = {
  ...
  init: function () {
    $("head").prepend("<link rel=\"stylesheet\" href=\""+base+"/assets/global/plugins/bootstrap-toastr/toastr.min.css\">");
    $("body").append("<script type=\"text/javascript\" src=\""+base+"/assets/global/plugins/bootstrap-toastr/toastr.min.js\"></script>");
    toastr.options = {
      closeButton: false,
      debug: false,
